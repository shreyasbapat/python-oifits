    ...
    def _process(self):
        ...
        for hdu in hdulist:
            ...
            if hdu.name == 'OI_WAVELENGTH':
                if dataobj.wavelength == None: dataobj.wavelength = {}
                insname = header['INSNAME']
                dataobj.wavelength[insname] = OI_WAVELENGTH(data.field('EFF_WAVE'), data.field('EFF_BAND'))
                ...
                if dataobj.array == None: dataobj.array = {}
        ...
        for hdu in hdulist:
            ...
            if hdu.name == 'OI_VIS':
                for row in data:
                    ...
                    timeobs = datetime.datetime(int(date[0]), int(date[1]), int(date[2])) + datetime.timedelta(
                        seconds=np.around(row.field('TIME'), 2))
                    ...
                    if array:
                        ...
                        station = [None, None]
                    dataobj.vis = np.append(dataobj.vis, OI_VIS(timeobs=timeobs, int_time=int_time, visamp=visamp,
                ...
                for row in data:
                    ...
                    if array:
                        ...
                        station = [None, None]
                    dataobj.vis2 = np.append(dataobj.vis2, OI_VIS2(timeobs=timeobs, int_time=int_time, vis2data=vis2data,
                                                                 vis2err=vis2err, flag=flag, ucoord=ucoord,
                                                                 vcoord=vcoord,
                ...
                for row in data:
                    ...
                    dataobj.t3 = np.append(dataobj.t3, OI_T3(timeobs=timeobs, int_time=int_time, t3amp=t3amp,
